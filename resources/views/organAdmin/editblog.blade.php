            ...
            <div class="posts-grid">
                <!-- Post Card 1 -->
                    ...
                    <div class="modal-body">
                        <form id="createPostForm" action="{{url('updateblog', $data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="postTitle">Title</label>
                                <input type="text" id="postTitle" name="title" value="{{$data->title}}"   class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label for="postOrgan">Organization Name</label>
                                <input type="text" id="postOrgan" name="organ_name" value="{{$data->organ_name}}"   class="form-control" required>
                            </div>
                            
                            
                            <div class="form-group">
                                <label for="postContent">Content</label>
                                <textarea id="postContent" class="form-control" name="content" value="{{$data->content}}"  rows="6"></textarea>
                            </div>
                            
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="postCategory">Category</label>
                                    <select id="postCategory" class="form-control" name="category" value="{{$data->category}}" >
                                        <option value="general">General</option>
                                        <option value="update">Update</option>
                                        <option value="urgent">Urgent</option>
                                        <option value="other">Other</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="postStatus" name="status" value="{{$data->status}}"   class="form-control">
                                        <option value="draft">Draft</option>
                                        <option value="published">Published</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="postImage" class="form-control" name="file" value="{{$data->image}}"  accept="image/*">
                            </div>
