            ...
            <div class="form-container">
                ...
                <form class="contact-form">
                    <div class="form-group">
                        ...
                        <input type="text" id="full-name" placeholder="Nasir Amme" required>
                    </div>
                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="tel" id="phone" placeholder="+251996656617">
                    </div>
                    <div class="form-group">
                        <label for="email">Email Address</label>
                        <input type="email" id="email" placeholder="nasiramme1511@gmail.com" required>
                    </div>
                    <div class="form-group">
